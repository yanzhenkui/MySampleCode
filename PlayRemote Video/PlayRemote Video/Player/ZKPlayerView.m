...
{
    return [[[NSBundle mainBundle] loadNibNamed:@"ZKPlayerView" owner:nil options:nil] firstObject];
}
- (void)awakeFromNib
{
    ...
    [self.progressSlider setThumbImage:[UIImage imageNamed:@"ZKPlayer.bundle/thumbImage"] forState:UIControlStateNormal];
    [self.progressSlider setMaximumTrackImage:[UIImage imageNamed:@"ZKPlayer.bundle/MaximumTrackImage"] forState:UIControlStateNormal];
    [self.progressSlider setMinimumTrackImage:[UIImage imageNamed:@"ZKPlayer.bundle/MinimumTrackImage"] forState:UIControlStateNormal];
